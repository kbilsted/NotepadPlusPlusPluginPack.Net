...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
    ...
    public interface IScintillaGateway
    {
        ...
        void DeleteRange(long start, long lengthDelete);
        ...
        /// </summary>
        long GetStyledText(TextRange tr);
        ...
        /// </summary>
        unsafe string GetCurLine(long length);
        ...
        /// </summary>
        void StartStyling(long start, int unused);
        ...
        /// </summary>
        void SetStyling(long length, int style);
        ...
        int MarkerAdd(long line, int markerNumber);

        /// <summary>Delete a marker from a line. (Scintilla feature 2044)</summary>
        void MarkerDelete(long line, int markerNumber);
        ...
        void MarkerAddSet(long line, int markerSet);
        ...
        unsafe void SetStylingEx(long length, string styles);
        ...
        /// </summary>
        unsafe void AutoCShow(long lengthEntered, string itemList);
        ...
        void SetSelectionEnd(long caret);
        ...
        void SetEmptySelection(long caret);
        ...
        long FindText(FindOption searchFlags, TextToFind ft);
        ...
        /// </summary>
        unsafe string GetLine(long line);
        ...
        void SetSel(long anchor, long caret);
        ...
        /// </summary>
        long GetTextRange(TextRange tr);
        ...
        /// </summary>
        void ScrollRange(long secondary, long primary);
        ...
        /// </summary>
        unsafe string GetText(long length);
        ...
        /// </summary>
        void SetTargetStart(long start);
        ...
        void SetTargetRange(long start, long end);
        ...
        /// </summary>
        unsafe long ReplaceTarget(long length, string text);
        ...
        /// </summary>
        unsafe long ReplaceTargetRE(long length, string text);
        ...
        /// </summary>
        unsafe long SearchInTarget(long length, string text);
        ...
        unsafe void CallTipShow(long pos, string definition);
        ...
        void CallTipSetPosStart(long posStart);
        ...
        void SetFoldExpanded(long line, bool expanded);

        /// <summary>Is a header line expanded? (Scintilla feature 2230)</summary>
        bool GetFoldExpanded(long line);
        ...
        unsafe void ToggleFoldShowText(long line, string text);
        ...
        void ExpandChildren(long line, FoldLevel level);
        ...
        /// </summary>
        void EnsureVisibleEnforcePolicy(long line);
        ...
        unsafe void AppendText(long length, string text);
        ...
        void SetFirstVisibleLine(long displayLine);
        ...
        /// </summary>
        long BraceMatch(long pos, int maxReStyle);
        ...
        /// </summary>
        void SetEdgeColumn(long column);
        ...
        void MultiEdgeAddLine(long column, Colour edgeColour);
        ...
        /// </summary>
        unsafe long SearchNext(FindOption searchFlags, string text);
        ...
        /// </summary>
        unsafe long SearchPrev(FindOption searchFlags, string text);
        ...
        /// </summary>
        IntPtr CreateDocument(long bytes, DocumentOption documentOptions);
        ...
        /// </summary>
        long PositionRelative(long pos, long relative);
        ...
        /// </summary>
        long PositionRelativeCodeUnits(long pos, long relative);
        ...
        unsafe void CopyText(long length, string text);
        ...
        long GetLineSelStartPosition(long line);
        ...
        long GetLineSelEndPosition(long line);
        ...
        /// </summary>
        void SetLengthForEncode(long bytes);
        ...
        /// </summary>
        long FindColumn(long line, long column);
        ...
        /// </summary>
        IntPtr GetRangePointer(long start, long lengthRange);
        ...
        long CharPositionFromPoint(int x, int y);
        ...
        /// </summary>
        long CharPositionFromPointClose(int x, int y);
        ...
        void SetSelection(long caret, long anchor);

        /// <summary>Add a selection (Scintilla feature 2573)</summary>
        void AddSelection(long caret, long anchor);
        ...
        /// </summary>
        int ChangeLexerState(long start, long end);
        ...
        /// </summary>
        long ContractedFoldNext(long lineStart);
        ...
        long LineFromIndexPosition(long pos, LineCharacterIndexType lineCharacterIndex);

        /// <summary>Retrieve the position measured in index units at the start of a document line. (Scintilla feature 2714)</summary>
        long IndexPositionFromLine(long line, LineCharacterIndexType lineCharacterIndex);
